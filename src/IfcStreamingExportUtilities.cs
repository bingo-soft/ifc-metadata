...
internal static class IfcStreamingExportUtilities
{
    ...
    internal static FileStream OpenOutputStream(FileInfo jsonTargetFile, int outputFileBufferSize, bool writeThrough)
    {
    ...
    internal static IfcExportReport ExportWithSharedPipeline(
        IfcStore model,
        IIfcProject project,
    ...
    internal static Dictionary<string, int> BuildObjectIdCounts(
        IIfcObjectDefinition root,
        bool preserveOrder,
        List<TraversalNode> bufferedTraversal = null)
    {
    ...
    private static void PushContainedElements(
        Stack<TraversalNode> stack,
        IIfcSpatialStructureElement spatialElement,
    ...
    private static void PushRelatedObjects(
        Stack<TraversalNode> stack,
